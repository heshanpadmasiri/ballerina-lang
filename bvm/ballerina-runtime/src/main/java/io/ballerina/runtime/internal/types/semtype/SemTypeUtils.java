...
// Utility class for various semtype related operations
// TODO: need to revisit this when we have a better idea about how we are going to use semtypes. I think we should
//  merge some of these with TypeHelper to give a common interface eventually. Currently keeping this seperate to avoid

...
public class BXmlType extends BType implements XmlType, TypeWithShape {
    ...
    private Optional<SemType> readonlyShapeOf(Object object) {
        if (object instanceof XmlSequence xmlSequence) {
            ...
            // return Optional.of(XmlUtils.xmlSequence(Builder.xmlElementType()));
        ...
        } else if (object instanceof XmlItem) {
            return Optional.of(Builder.xmlElementType());
        } else if (object instanceof XmlComment) {
            return Optional.of(Builder.xmlCommentType());
        } else if (object instanceof XmlPi) {
            return Optional.of(Builder.xmlPIType());
        }
    ...
    private static boolean isReadOnly(XmlValue xmlValue) {
        if (xmlValue instanceof XmlSequence) {
            return true;
        } else if (xmlValue instanceof XmlText) {
            return true;
        }

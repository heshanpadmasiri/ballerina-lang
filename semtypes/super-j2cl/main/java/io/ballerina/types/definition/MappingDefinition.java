...
public class MappingDefinition implements Definition {
    ...
    public SemType define(Env env, List<CellField> fields, CellSemType rest) {
        ...
        MappingAtomicType atomicType = MappingAtomicType.from(sfh.names.toArray(new String[0]),
                sfh.types.toArray(new CellSemType[0]), rest);
        Atom atom;
    ...
    private SplitField splitFields(List<CellField> fields) {
        CellField[] sortedFields = fields.toArray(new CellField[0]);
